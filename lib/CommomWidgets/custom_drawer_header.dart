...
// const double _kDrawerHeaderHeight = 220.0 + 1.0; // bottom edge
...
/// satisfied by putting the [CustomDrawerHeader] in a [Drawer].
///
/// See also:
///
///  * [UserAccountsDrawerHeader], a variant of [CustomDrawerHeader] that is
...
class CustomDrawerHeader extends StatelessWidget {
  ...
  ///
  /// The [CustomDrawerHeader] additionally offsets the child by the height of the
  /// system status bar.
  ///
