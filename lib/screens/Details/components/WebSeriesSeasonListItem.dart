...
class WebSeriesSeasonListItem extends StatelessWidget {
  WebSeriesSeasonListItem(
      {Key? key,
      required this.imageUrl,
      required this.seriesSeasonName,
      required this.watchingListData,
      this.onTap})
      : super(key: key);

  final String imageUrl;
  final String seriesSeasonName;
  final SeasonListData watchingListData;
